...
// Kotlin imports with aliases to avoid conflicts
...
public class HandlerRegistry {
  ...
  static {
    ...
    registerKotlinHandlers(genericHandler);
  }
  ...
  private static void registerKotlinHandlers(SimpleHandlerFactory genericHandler) {
    ...
    register(KtNodeTypes.THROW, genericHandler.create(c -> c.throwStatement, c -> c.throwStatementDescription));
  }
